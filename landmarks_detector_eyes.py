...
class LandmarksDetectorEyes(Module):
    POINTS_NUMBER = 35

    def __init__(self, core, model):
        super(LandmarksDetectorEyes, self).__init__(core, model, 'Landmarks Detection Eyes')
    ...
    def enqueue(self, input):
        return super(LandmarksDetectorEyes, self).enqueue({self.input_tensor_name: input})
